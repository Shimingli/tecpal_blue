package com.tecpal.blue.tecpal_blue.entity;
...
public class ScanResultEntity {
    ...
    public ScanResultEntity(String deviceId, String deviceName, int rssi, int mtu, boolean isConnectable, UUID[] overflowServiceUUIDs,
